% Wasatch use to plot every step of the acquisition,
% including baseline correction and save as files
%
% Dayle Kotturi September 2020
...
% 20200922 want dark                if mod(counter,countBetweenPlots) == 0
...
%                 end
                ...
                hold off
                myTitle = sprintf('%s gel #%d calibration curve %s ratiommetric spectra', gelTypeName, gelNumber, studyName);
                ...
                hold off
                myTitle = sprintf('%s gel #%d calibration curve study %s time series', gelTypeName, gelNumber, studyName);
                title(myTitle, 'FontSize', myFont);
