...
black =   [0.0, 0.0, 0.0];
magenta = [1.0, 0.0, 1.0];
punchColor = [magenta; red; rust; gold; green; ciel; blue; purple; black];
myTextFont = 30;
numPoints = 1024;
...
subDirStem = [ "1_MBAonphantom10thick\1", "2_MBAunderthinphantom10onthick\1", ...
    "3_MBAunderthinphantom10onthick1000ms\1", "4_MBAunderthinphantom10onthickOffset13redo\1", ...
    "5_MBAunderthinphantom10onthickOffset12\1", "6_MBAunderthinphantom10onthickOffset11\1", ...
    "7_MBAunderthinphantom10onthickOffset10\1", "8_MBAunderthinphantom10onthickOffset10redo\1", ...
    "9_MBAunderthinphantom10onthickOffset7\1" ];
...
title('PEG gel#18 punch#4 under Phantom 10', 'FontSize', myTextFont);
...
legend([ h(1), h(2), h(3), h(4), h(5), h(6), h(7), h(8), h(9) ], ...
    ...
    '0 mm offset 1000 ms', '0 mm offset redo', ...
    '1 mm offset', '2 mm offset', ...
    '3 mm offset under phant', '3 mm offset redo', ...
    '6 mm offset' );
