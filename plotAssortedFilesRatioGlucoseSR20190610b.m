...
if plotOption == 1
    dirStem = "H:\Documents\Data\Made by Sureyya\Alginate\alg gox1\";
    subDirStem1 = "punch5 0mgdL";
    subDirStem2 = "punch6 100mgdL";
    subDirStem3 = "punch7 200mgdL";
    subDirStem4 = "punch8 300mgdL";
    subDirStem5 = "punch9 400mgdL";
else
...
if plotOption == 1
    text(x, y, 'Punch5 0 mg/dL', 'Color', green, 'FontSize', myTextFont);
    text(x, y, '______________', 'Color', green, 'FontSize', myTextFont);
    y = y - deltaY;
    text(x, y, 'Punch6 100 mg/dL', 'Color', gold, 'FontSize', myTextFont);
    text(x, y, '________________', 'Color', gold, 'FontSize', myTextFont);
    y = y - deltaY;
    text(x, y, 'Punch7 200 mg/dL', 'Color', rust, 'FontSize', myTextFont);
    text(x, y, '________________', 'Color', rust, 'FontSize', myTextFont);
    y = y - deltaY;
    text(x, y, 'Punch8 300 mg/dL', 'Color', red, 'FontSize', myTextFont);
    text(x, y, '________________', 'Color', red, 'FontSize', myTextFont);
    y = y - deltaY;
    text(x, y, 'Punch9 400 mg/dL', 'Color', cherry, 'FontSize', myTextFont);
...
if plotOption == 1
    title('Alg GOx1 soaked in static glucose buffer for 1 hour on quartz');
else
    title('Alg GOx2 soaked in static glucose buffer for 1 hour on quartz');
end
