...
dirStem = "R:\Students\Dayle\Data\Made by Sureyya\Alginate\alg gox2\Glucose punch3";
...
text(x, y, 'Batch MC8G', 'Color', green, 'FontSize', myTextFont);
text(x, y, '__________', 'Color', green, 'FontSize', myTextFont);
