...
dirStem = "R:\Students\Dayle\Data\SORS\";
subDirStem = [ "PEG\gel 18\punch4Phantom1onQuartz\1", "other\gel 0\phantom1onQuartz\1" ];
...
% value
legend([h(1), h(2)], 'MBA-AuNPS in gel under phantom 1',"Phantom 1 alone");
