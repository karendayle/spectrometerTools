...
global dirStem;
dirStem = "H:\Documents\Data\Made by Sureyya\40 nm diameter\";
%dirStem = "Z:\Documents\Data\flow through 2X v5\"; % Analyzing using remote Matlab client
subDirStem1 = "1 in original buffer";
subDirStem2 = "2 in pH 4";
subDirStem3 = "3 in pH 10";
...
global tRef;
tRef = datenum(2018, 10, 24, 14, 0, 0);
...
hold off
title('Normalized intensity at pH-sensitive peaks vs time in 40 nm particles in buffer', ...
