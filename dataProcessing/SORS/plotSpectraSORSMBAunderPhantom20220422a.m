...
black =   [0.0, 0.0, 0.0];
magenta = [1.0, 0.0, 1.0];
punchColor = [ red; gold; green; ciel; blue; purple ];
myTextFont = 30;
numPoints = 1024;
...
subDirStem = [ "MBA uncovered 0 mm\1", "MBA covered 0 mm\1", ...
    "MBA 1 mm\1", "MBA 2 mm\1", ...
    "MBA 3 mm\1", "MBA 4 mm\1" ];
