...
global dirStem
dirStem = "H:\Documents\Data\Made by Sureyya\PEG\study 5 gel without NPs 19.4 mW pwr on quartz no flowcell\";
%dirStem = "Z:\Documents\Data\Made by Sureyya\PEG\study 5 gel without NPs 19.4 mW pwr on quartz no flowcell"; % Analyzing using remote Matlab client
subDirStem1 = "1 saturated";
subDirStem2 = "2 no longer saturated after adusting focus";
subDirStem3 = "3 moved laterally with same focus as 2";
subDirStem4 = "4 moved again laterally with same focus as 2";
...
hold off
title('PEG gel 1 on quartz on wellplate no NPS and no flowcell', 'FontSize', myFont);
xlabel('Wavenumber (cm^-^1)', 'FontSize', myFont); % x-axis label
ylabel('Arbitrary Units (A.U.)', 'FontSize', myFont); % y-axis label
%ylabel('Arbitrary Units (A.U.)', 'FontSize', myFont); % y-axis label to show saturation
...
function g = myPlot(subDirStem, myColor)
    ...
    if numberOfSpectra > 0
        ...
        for I = 1 : numberOfSpectra
            ...
            %normalized = thisdata(2,:)/denominator1; % 11/28/18 use to show saturation
