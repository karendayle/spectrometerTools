...
subDirStem = [ "polystyrene1\1", "phantom1\1", "phantom1OnQuartz\1" ];
...
title('Phantom 1', 'FontSize', myTextFont);
...
% value
legend([h(1), h(2), h(3)], 'Polystyrene (PS)', 'Phantom on PS', 'Phantom on Quartz');
