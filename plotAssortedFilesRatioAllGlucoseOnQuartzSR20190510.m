...
%dirStem = "H:\Documents\Data\Made by Sureyya\Alginate\gel 5 aka alg gox 1\";
dirStem = "H:\Documents\Data\Made by Sureyya\Alginate\gel 6 aka alg gox 2\";
...
for K = 1:4
    switch K
        ...
        case 5
            pHcolor = cherry;
            num5 = myPlot(subDirStem4, pHcolor);
...
text(x, y, '0mg/dL(neutral)', 'Color', green, 'FontSize', myTextFont);
text(x, y, '________________________', 'Color', green, 'FontSize', myTextFont);
y = y - deltaY;
text(x, y, '100mg/dL', 'Color', gold, 'FontSize', myTextFont);
text(x, y, '_________________________', 'Color', gold, 'FontSize', myTextFont);
y = y - deltaY;
text(x, y, '200mg/dL', 'Color', rust, 'FontSize', myTextFont);
text(x, y, '________________________', 'Color', rust, 'FontSize', myTextFont);
y = y - deltaY;
text(x, y, '300mg/dL', 'Color', red, 'FontSize', myTextFont);
text(x, y, '_________________________', 'Color', red, 'FontSize', myTextFont);
y = y - deltaY;
text(x, y, '400mg/dL(acidic)', 'Color', cherry, 'FontSize', myTextFont);
text(x, y, '_________________________', 'Color', cherry, 'FontSize', myTextFont);
hold off
