...
if gelOption == 1
    ...
    subDirStem3 = "3 pH10";
    subDirStem4 = "4 pH7";
    subDirStem5 = "3 pH10 redo 40 msmts";
    subDirStem6 = "4 pH7 redo";
    subDirStem7 = "5 pH10";
    subDirStem8 = "6 pH4";
    subDirStem9 = "7 pH10";
    subDirStem10 = "8 pH7";
    subDirStem11 = "9 pH4";
    subDirStem12 = "10 next day pH4 3 msmts";
    Kmin = 1;
    Kmax = 11;
end
...
for K = Kmin:Kmax
    ...
    switch K
        ...
        case 5
            pHcolor = blue;
            num5 = myPlot(subDirStem5, pHcolor, 9.75);
            fprintf('Case 5: %d spectra plotted in blue\n', num5);  
        case 6
            pHcolor = green;
            num6 = myPlot(subDirStem6, pHcolor, 9.70);
            fprintf('Case 5: %d spectra plotted in green\n', num6);             
        case 7
            pHcolor = blue;
            num7 = myPlot(subDirStem7, pHcolor, 9.70);
            fprintf('Case 7: %d spectra plotted in blue\n', num7);
        case 8
            pHcolor = red;
            num8 = myPlot(subDirStem8, pHcolor, 9.70);
            fprintf('Case 8: %d spectra plotted in red\n', num8); 
        case 9
            pHcolor = blue;
            num9 = myPlot(subDirStem9, pHcolor, 9.70);
            fprintf('Case 9: %d spectra plotted in blue\n', num9);
        case 10
            pHcolor = green;
            num10 = myPlot(subDirStem10, pHcolor, 9.70);
            fprintf('Case 9: %d spectra plotted in green\n', num10);
        case 11
            pHcolor = red;
            num11 = myPlot(subDirStem11, pHcolor, 9.70);
            fprintf('Case 9: %d spectra plotted in red\n', num11);
        case 12
            pHcolor = red;
            num12 = myPlot(subDirStem12, pHcolor, 9.70);
            fprintf('Case 9: %d spectra plotted in red\n', num12);
    end
end    
