...
if gelOption == 1
    ...
    if gelOption == 2
        ...
        if gelOption == 3
            dirStem = "R:\Students\Dayle\Data\Made by Sureyya\Alginate\gel 10\punch4 flowcell2 avgs\";
        else
            if gelOption == 4
                dirStem = "R:\Students\Dayle\Data\Made by Sureyya\Alginate\gel 10\punch4 flowcell3 avgs\";
            end
        end
    end
end
...
if gelOption == 1
    ...
    if gelOption == 2
        ...
        if gelOption == 3
            ...
            subDirStem6 = "6 400mgdL 0mLmin";
            subDirStem7 = "7 400mgdL 0mLmin fresh buffer";
            subDirStem8 = "8 400mgdL 4mLmin fresh buffer";
            subDirStem9 = "9 400mgdL 0mLmin fresh buffer";
            subDirStem10 = "10 400mgdL 0mLmin another try";
            subDirStem11 = "11 0mgdL 4mLmin";
            subDirStem12 = "12 400mgdL 4mLmin";
            subDirStem13 = "13 400mgdL 0mLmin";
            subDirStem14 = "14 400mgdL 0mLmin";
            subDirStem15 = "15 400mgdL 0mLmin";
            subDirStem16 = "16 400mgdL 0mLmin";
            Kmin = 1;
            Kmax = 16;
        else
            if gelOption == 4
                subDirStem1 = "placeholder";
                subDirStem2 = "1 400mgdL 0mLmin";
                subDirStem3 = "2 400mgdL 4mLmin";
                Kmin = 2;
                Kmax = 3;
            end
        end
...
if gelOption == 1
    ...
    if gelOption == 2
        tRef = datenum(2019, 11, 10, 19, 51, 03);
    else
        if gelOption == 3
            tRef = datenum(2019, 11, 12, 19, 28, 39);
        else
            if gelOption == 4
                tRef = datenum(2019, 11, 16, 9, 36, 28);
            end
        end
    end
end
...
y = y - deltaY;
text(x, y, '+ = normalized local peak near 1702 cm^-^1', 'Color', black, 'FontSize', myTextFont);
y = y - deltaY;
