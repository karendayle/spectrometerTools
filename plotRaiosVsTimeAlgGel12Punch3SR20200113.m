...
for K = Kmin:Kmax
    ...
    switch K
        ...
        case 5
            pHcolor = blue;
            num5 = myPlot(subDirStem5, pHcolor, 9.85);
            fprintf('Case 5: %d spectra plotted in blue\n', num5);  
        case 6
            pHcolor = red;
            num6 = myPlot(subDirStem6, pHcolor, 9.85);
            fprintf('Case 6: %d spectra plotted in red\n', num6);
        case 7
            pHcolor = blue;
            num7 = myPlot(subDirStem7, pHcolor, 9.85);
            fprintf('Case 7: %d spectra plotted in blue\n', num7);
        case 8
            pHcolor = green;
            num8 = myPlot(subDirStem8, pHcolor, 9.85);
            fprintf('Case 8: %d spectra plotted in green\n', num8); 
        case 9
            pHcolor = red;
            num9 = myPlot(subDirStem9, pHcolor, 9.85);
...
hold off
title('54nm MBA Au NPs in MCs in alginate in flowcell', ...
