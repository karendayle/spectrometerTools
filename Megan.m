...
integrationTimeMS = 2000; % Two second integration 11/7/2018
xMin = 0;
xMax = 1800;
yMin = 0;
yMax = 12000;
...
numIter = 1; % Number of spectra to average 11/7/2018
...
waitBetweenAverages = 1; % Acquire one averaged sample per 10 minutes
% load the DLL
