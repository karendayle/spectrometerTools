...
for K = 1 : 3
  if (K == 1)
      ...
      % UGH, this function only in 2018b. How do I get it to char array for
      % fullfile
...
plot(thisdata1(:,1), thisdata1(:,2), 'black', thisdata2(:,1), ...
    thisdata2(:,2), 'cyan', thisdata3(:,1), thisdata3(:,2), 'red', ...
