    ...
    switch L
        case 1 
            ...
            for K = 1:numOffset
                switch K
                    case 1
                        dirStem = "R:\Students\Dayle\Data\SORS\pHEMA\gel 19\MBA under skin 0mm 2s\1";
                    case 2
                        dirStem = "R:\Students\Dayle\Data\SORS\pHEMA\gel 19\MBA under skin 1mm 2s\1"; 
                    case 3
                        dirStem = "R:\Students\Dayle\Data\SORS\pHEMA\gel 19\MBA under skin 2mm 2s\1";
                    case 4
                        dirStem = "R:\Students\Dayle\Data\SORS\pHEMA\gel 19\MBA under skin 3mm 2s\1";
                    case 5
                        dirStem = "R:\Students\Dayle\Data\SORS\pHEMA\gel 19\MBA under skin 4mm 2s\1";
                end
...
for L=1:numDepth
    switch L
        case 1
            for K=1:numOffset
                for I=1:numAvg
                    plot(depth(L)-0.1, intensityPeak1(L,K,I), 's', ...
                        'Color', punchColor(K,:), 'MarkerSize',30);
                    hold on
                    plot(depth(L), intensityPeak2(L,K,I), 'o', ...
                        'Color', punchColor(K,:), 'MarkerSize',30);
                    hold on
                    plot(depth(L)+0.1, intensityPeak3(L,K,I), '^', ...
                        'Color', punchColor(K,:), 'MarkerSize',30);
                    hold on
                end
            end
...
myTextFont = 30;
myTextFont2 = 35;
xlabel('Rat skin thickness (mm)', 'FontSize', myTextFont); % x-axis label
...
y = y - deltaY;
text(x, y, 'Skin peak at 487 cm-1: triangle', 'Color', black, 'FontSize', myTextFont);
y = y - deltaY;
