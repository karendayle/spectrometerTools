...
global dirStem
%dirStem = "H:\Documents\Data\Made by Sureyya\PolyHEMA\gel 2\";
dirStem = "Z:\Documents\Data\Made by Sureyya\PolyHEMA\gel 2\"; % Analyzing using remote Matlab client
subDirStem1 = "washed on quartz on well plate 0.332 pwr";
...
deltaY = 0.1;
deltaX = 100;
text(x, y, 'sample', 'Color', black, 'FontSize', myTextFont);
text(x, y, '___', 'Color', black, 'FontSize', myTextFont);
...
hold off
title('PolyHEMA gel 2 with 3X MCs and NPs on quartz on wellplate without buffer', 'FontSize', myFont);
