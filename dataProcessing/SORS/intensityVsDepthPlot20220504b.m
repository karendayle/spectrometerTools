...
% This script plots 20220425 datasets for MBA under 1, 2 and a redone dataset with 
% 3 phantoms
...
numDepth = 3; % depth = 0.5, 1.0, 1.5mm
numOffset = 5; % offset = 0.0-4.0mm
numAvg = 3; % each measurement consists of 3 averaged spectra
for L = 1:numDepth 
    switch L
        case 1 % depth = 0.5mm, aka '1 phant'
            for K = 1:numOffset
                switch K
                    case 1
                        dirStem = "R:\Students\Dayle\Data\SORS\PEG\gel 18\MBA 1 phant 0 mm\1";
                    case 2
                        dirStem = "R:\Students\Dayle\Data\SORS\PEG\gel 18\MBA 1 phant 1 mm\1"; 
                    case 3
                        dirStem = "R:\Students\Dayle\Data\SORS\PEG\gel 18\MBA 1 phant 2 mm\1";
                    case 4
                        dirStem = "R:\Students\Dayle\Data\SORS\PEG\gel 18\MBA 1 phant 3 mm\1";
                    case 5
                        dirStem = "R:\Students\Dayle\Data\SORS\PEG\gel 18\MBA 1 phant 4 mm\1";
                end
        ...
        case 2 % depth = 1.0mm, aka '2 phant'
            for K = 1:numOffset
                switch K
                    case 1
        ...
        case 3 % depth = 1.5mm, aka '3 phant'
            for K = 1:numOffset
                switch K
                    case 1
                        dirStem = "R:\Students\Dayle\Data\SORS\PEG\gel 18\MBA 3 phant 0 mm redo\1";
                    case 2
                        dirStem = "R:\Students\Dayle\Data\SORS\PEG\gel 18\MBA 3 phant 1 mm redo\1"; 
                    case 3
                        dirStem = "R:\Students\Dayle\Data\SORS\PEG\gel 18\MBA 3 phant 2 mm redo\1";
                    case 4
                        dirStem = "R:\Students\Dayle\Data\SORS\PEG\gel 18\MBA 3 phant 3 mm redo\1";
                    case 5
                        dirStem = "R:\Students\Dayle\Data\SORS\PEG\gel 18\MBA 3 phant 4 mm redo\1";
                end
...
text(x, y, 'Laser output power: 50 mW', 'Color', black, 'FontSize', myTextFont);
y = y - deltaY;
