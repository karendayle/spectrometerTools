...
for K = 1:2
    switch K
        ...
        case 2
            ...
            fprintf('Case 2: %d spectra plotted in ciel\n', num2);            
    end
end    
...
text(x, y, 'MP6 MCs', 'Color', green, 'FontSize', myTextFont);
text(x, y, '________', 'Color', green, 'FontSize', myTextFont);
y = y - deltaY;
text(x, y, 'MP7 MCs', 'Color', ciel, 'FontSize', myTextFont);
text(x, y, '________', 'Color', ciel, 'FontSize', myTextFont);
