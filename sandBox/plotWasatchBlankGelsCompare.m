% Compare datasets blank gel #2 from April and Sept 2021 in different directories
...
dirStem1 = "R:\Students\Dayle\Data\Made By Waqas\Blank gels\gel ";
subDirStem1 = ["\blank\1\", "\blank2\1\", "\blank3\1\" ];
dirStem2 = "R:\Students\Dayle\Data\Made by Waqas\Blank gels\gel ";
subDirStem2 = ["\retest\retest 15 percent BSA 1\1\", "\retest\retest 15 percent BSA 2\1\", "\retest\retest 15 percent BSA 3\1\" ];
    ...
    for L = 1 : 2
        for J = 1 : 3
            switch L % 1 is april data, 2 is sept data
                case 1
                    str_dir_to_search = dirStem1 + string(K) + subDirStem1(J); 
                    % args need to be strings
                case 2
                    str_dir_to_search = dirStem2 + string(K) + subDirStem2(J); 
            end
