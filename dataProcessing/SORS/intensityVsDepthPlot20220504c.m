...
% This script plots 20220426 datasets for MBA under 1, 2 and 3 phantoms
    ...
    switch L
        ...
        case 3 % depth = 1.5mm, aka '3 phant'
            for K = 1:numOffset
                switch K
                    case 1
                        dirStem = "R:\Students\Dayle\Data\SORS\PEG\gel 18\MBA 3 phant 0 mm redo2\1";
                    case 2
                        dirStem = "R:\Students\Dayle\Data\SORS\PEG\gel 18\MBA 3 phant 1 mm redo2\1"; 
                    case 3
                        dirStem = "R:\Students\Dayle\Data\SORS\PEG\gel 18\MBA 3 phant 2 mm redo2\1";
                    case 4
                        dirStem = "R:\Students\Dayle\Data\SORS\PEG\gel 18\MBA 3 phant 3 mm redo2\1";
                    case 5
                        dirStem = "R:\Students\Dayle\Data\SORS\PEG\gel 18\MBA 3 phant 4 mm redo2\1";
                end
...
% text(x, y, 'Laser output power: 75 mW', 'Color', black, 'FontSize', myTextFont);
% y = y - deltaY;
