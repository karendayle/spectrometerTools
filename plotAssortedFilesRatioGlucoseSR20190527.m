...
subDirStem1 = "MP6A\0mgdL after overnight soak";
subDirStem2 = "MP6B\400mgdL after overnight soak";
subDirStem3 = "MP7A\0mgdL after overnight soak";
subDirStem4 = "MP7B\400mgdL after overnight soak";
...
text(x, y, 'MP6A 0mg/dL(neutral)', 'Color', green, 'FontSize', myTextFont);
text(x, y, '____________________', 'Color', green, 'FontSize', myTextFont);
%text(x + deltaX, y, 'Laser Power = 19.4 mW', 'FontSize', myTextFont);
y = y - deltaY;
text(x, y, 'MP6B 400mg/dL(acidic)', 'Color', red, 'FontSize', myTextFont);
text(x, y, '_____________________', 'Color', red, 'FontSize', myTextFont);
%text(x + deltaX, y, '5 second integration time per acq', 'FontSize', myTextFont);
y = y - deltaY;
text(x, y, 'MP7A 0mg/dL(neutral)', 'Color', ciel, 'FontSize', myTextFont);
text(x, y, '____________________', 'Color', ciel, 'FontSize', myTextFont);
y = y - deltaY;
text(x, y, 'MP7B 400mg/dL(acidic)', 'Color', rust, 'FontSize', myTextFont);
text(x, y, '_____________________', 'Color', rust, 'FontSize', myTextFont);
hold off
