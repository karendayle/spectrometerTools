% Plot files in different directories. Calculate the std dev for each set of spectra
% and use for error bars
% Dayle Kotturi August 2019
...
xlabel('Wavenumber (cm^-^1)', 'FontSize', myTextFont); % x-axis label
...
axes('pos',[.255 .45 .44 .5]); 
%imshow('R:\Students\Dayle\Data\Made by Sureyya\Alginate\alg gox2\framed inset with error bars.jpg');
imshow('C:\Users\karen\Downloads\inset.jpg');
