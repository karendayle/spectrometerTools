        ...
        case 1
            if OLD 
                ...
                if NEW
                    myTitle = 'Step 1 MBA on AuNPs';
                    % myTitle = 'Figure S1';
                    dirStem = "C:\Users\karen\Documents\Data\Wasatch\madeBySuhashAndWaqas1mMStep1\";
                    dir_to_search = char(dirStem); % 2020/2/19 add comma
                    ...
                    if numberOfSpectra > 0
                        for I = 1 : numberOfSpectra
                            ...
                            %for n = 1:numel(thisfilename)
                            %thisdata = csvread(thisfilename,1);
                            %end
                            fclose(fileID);

                            %thisdata=reshape(textread(thisfilename,'%f','delimiter',',','headerlines',1),1024,[])
                        end
                    end
