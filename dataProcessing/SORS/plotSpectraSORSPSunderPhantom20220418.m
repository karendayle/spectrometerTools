...
subDirStem = [ "PSonphantom10thickOffset13\1", ...
    "PSunderthinphantom10onthickOffset13\1", ...
    "PSunderthinphantom10onthickOffset12\1", ...
    "PSunderthinphantom10onthickOffset11\1", ...
    "PSunderthinphantom10onthickOffset10\1", ...
    "PSunderthinphantom10onthickOffset9\1", ...
    "PSunderthinphantom10onthickOffset8\1", ...
    "PSunderthinphantom10onthickOffset7\1", ...
    "PSunderthinphantom10onthickOffset8\1", ...
    "PSunderthinphantom10onthickOffset9\1", ...
    "PSunderthinphantom10onthickOffset10\1", ...
    "PSunderthinphantom10onthickOffset13\1", ...
...
h = gobjects(14); % not required, but more efficient
Kstart = 1;
Kend = 14;
...
title('Polystyrene under Phantom 10', 'FontSize', myTextFont);
...
% caliper position = 13 - offset (I acquired from caliper position 13, 12,
% ... 0 mm as detector stepped away from sample
legend([ h(1), h(2), h(3), h(4), h(5), h(6), h(7), h(8), h(9), h(10), h(11), h(12), h(13), h(14) ], ...
    '0 mm offset no cover', '0 mm offset under phant', ...
    '1 mm offset under phant', '2 mm offset under phant', ...
    '3 mm offset under phant', '4 mm offset under phant', ...
    '5 mm offset under phant', '6 mm offset under phant', ...
    '7 mm offset under phant', '8 mm offset under phant', ...
    '9 mm offset under phant', '10 mm offset under phant', ...
    '11 mm offset under phant', '12 mm offset under phant', ...
    '13 mm offset under phant' );
